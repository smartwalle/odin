...
func main() {
	...
	// 添加权限信息
	fmt.Println(s.AddPermission(1, "yf", "yf1", "研发权限1", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf2", "研发权限2", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf3", "研发权限3", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf4", "研发权限4", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf5", "研发权限5", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf6", "研发权限6", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf7", "研发权限7", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf8", "研发权限8", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yf", "yf9", "研发权限9", "", odin.Enable))

	fmt.Println(s.AddPermission(1, "yx", "yx1", "营销权限1", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx2", "营销权限2", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx3", "营销权限3", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx4", "营销权限4", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx5", "营销权限5", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx6", "营销权限6", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx7", "营销权限7", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx8", "营销权限8", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "yx", "yx9", "营销权限9", "", odin.Enable))

	fmt.Println(s.AddPermission(1, "cw", "cw1", "财务权限1", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw2", "财务权限2", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw3", "财务权限3", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw4", "财务权限4", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw5", "财务权限5", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw6", "财务权限6", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw7", "财务权限7", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw8", "财务权限8", "", odin.Enable))
	fmt.Println(s.AddPermission(1, "cw", "cw9", "财务权限9", "", odin.Enable))
