...
CREATE TABLE `odin_grant` (
  `ctx_id` bigint(20) DEFAULT 0,
  `object_id` varchar(64) DEFAULT NULL,
  `role_id` int(11) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
  UNIQUE KEY `odin_grant_destination_id_role_id_pk` (`ctx_id`,`object_id`,`role_id`),
  KEY `odin_grant_ctx_id_index` (`ctx_id`),
...
CREATE TABLE `odin_group` (
  ...
  KEY `odin_group_ctx_id_index` (`ctx_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
```
...
CREATE TABLE `odin_permission` (
  ...
  KEY `odin_permission_ctx_id_index` (`ctx_id`),
...
CREATE TABLE `odin_role` (
  ...
  KEY `odin_role_ctx_id_index` (`ctx_id`),
...
CREATE TABLE `odin_role_permission` (
  ...
  `created_on` datetime DEFAULT NULL,
  UNIQUE KEY `odin_role_permission_role_id_permission_id_pk` (`ctx_id`,`role_id`,`permission_id`),
  KEY `odin_role_permission_role_id_index` (`role_id`),
  KEY `odin_role_permission_ctx_id_index` (`ctx_id`),
